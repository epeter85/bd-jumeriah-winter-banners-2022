function mainInit() {
  ...
  //Backgrounds
  main_image = generateSprite('images/main_image.jpg', 333, 263);
...
function init() {
  ...
  //set init placement
  gsap.set(main_image, { x: -23, y: -6, scale: 0.95 });
...
function frame01() {
  ...
  fr1.to(main_image, { duration: bannerDuration, x: 0, y: 0, scale: 1, ease: panEaseStyle }, 'fr1');
}
