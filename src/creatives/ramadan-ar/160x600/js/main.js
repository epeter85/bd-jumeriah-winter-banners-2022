function mainInit() {
  ...
  //Backgrounds
  main_image = generateSprite('images/main_image.jpg', 228, 614);
...
function init() {
  ...
  //set init placement
  gsap.set(main_image, { x: -50, y: 0, scale: 1 });
...
function frame01() {
  ...
  fr1.to(main_image, { duration: bannerDuration, x: -20, y: 0, scale: 1, ease: panEaseStyle }, 'fr1');
}
