function mainInit() {
  ...
  //Backgrounds
  main_image = generateSprite('images/main_image.jpg', 219, 600);
  ...
  // template = generateSprite('images/template/160x600_F1.jpg');
...
function frame01() {
  ...
  fr1.to(
    main_image,
    { duration: bannerDuration, x: -20, y: 0, scale: 1, ease: panEaseStyle },
    'fr1'
  );
}
