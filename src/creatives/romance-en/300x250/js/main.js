...
function frame00() {
    ...
    masterTimeline.to(stage, .25, {opacity:1}, 'master+=.25')
...
function frame01() {
    ...
    fr1.to(main_image, {duration: bannerDuration, x:-10, y:19, scale:1.21, ease:panEaseStyle}, 'fr1');
}

function frame02() {
    var fr3 = gsap.timeline();

    fr3.to(copy1, easeSpeed, {opacity:0, ease: easeStyle}, 'fr2')
...
function resolve() {
    ...
    resolve.to([copy2, logo1], .75, {opacity:0, ease: easeStyle}, 'resolve')
