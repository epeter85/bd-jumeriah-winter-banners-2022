...
function mainInit() {
  ...
  //Backgrounds
  main_image = generateSprite('images/main_image.jpg', 326, 280);
...
function init() {
  ...
  //set init placement
  gsap.set(main_image, { x: -43, y: -50, scale: 1.25 });
...
function frame01() {
  ...
  fr1.to(
    main_image,
    { duration: bannerDuration, x: -18, y: -10, scale: 1, ease: panEaseStyle },
    'fr1'
  );
}
