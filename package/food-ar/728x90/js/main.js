...
function mainInit() {
  ...
  //Backgrounds
  main_image = generateSprite('images/main_image.jpg', 729, 119);
...
function init() {
  ...
  //set init placement
  gsap.set(main_image, { x: 0, y: -30, scale: 1 });
...
function frame01() {
  ...
  fr1.to(main_image, { duration: bannerDuration, x: 0, y: -15, scale: 1, ease: panEaseStyle }, 'fr1');
}
